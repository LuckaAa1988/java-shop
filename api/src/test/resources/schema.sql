...
VALUES ('Смартфон Galaxy S24', 'Флагманский смартфон с мощной камерой и дисплеем 120 Гц.', '/images/mob.jpg', 89999.00),
       ('Ноутбук MacBook Pro', 'Мощный ноутбук с процессором M3 Pro и 16 ГБ оперативной памяти.', '/images/nout.jpg', 229999.00),
       ('Игровая приставка PlayStation 5', 'Консоль нового поколения с поддержкой 4K и SSD.', '/images/other.jpg', 57999.00),
       ...
       ('Робот-пылесос Xiaomi', 'Умный пылесос с навигацией и управлением через приложение.', '/images/other.jpg', 32999.00),
